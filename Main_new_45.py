...
async def main():
    ...
    # POPRAWNA WERSJA DO WKLEJENIA
    horizontal_files = { "grass.png", "wall17.png"}
    HORIZONTAL_SURFACES = {} # Zmieniamy nazwę dla przejrzystości
    for filename in horizontal_files:
        try:
            path = os.path.join(TEXTURE_PATH, filename)
            # Po prostu wczytujemy obrazek i przechowujemy go w słowniku
...
class Renderer:
    ...
    def draw_floor_and_ceiling(self):
        """
        FINALNA, ZOPTYMALIZOWANA WERSJA: Bazuje na kodzie użytkownika,
        dodając optymalizację wydajności dla logiki "paddingu".
        """
        ...
        # --- OPTYMALIZACJA: Krok 1 - Wstępne zebranie kafelków z paddingiem ---
        # Zamiast sprawdzać całą mapę, tworzymy małą listę tylko tych kafelków
        # z paddingiem, które są w ogóle w zasięgu wzroku gracza.
