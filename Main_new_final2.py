...
class Renderer:
    ...
    def draw_walls(self):
        ...
        for ray in range(NUM_RAYS):
            # Lista na segmenty ścian TYLKO dla tej jednej, aktualnej kolumny
            column_segments = []
            ...
            for _ in range(MAX_DEPTH):
                ...
                if any(b['id'] in self.SOLID_WALLS for b in wall_blocks):
                    break
            
            # --- POPRAWIONA LOGIKA ---
            # Sortowanie i rysowanie odbywa się tutaj, WEWNĄTRZ pętli `for ray`,
            # ale PO zakończeniu podróży pojedynczego promienia.
