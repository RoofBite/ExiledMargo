...
async def main():
    ...
    WALLS = {k: pygame.image.load(os.path.join(TEXTURE_PATH, f)).convert() for k, f in {1:'wall5.png', 2:'wall2.png', 97:'wall17.png',96: 'door_closed_wall.png',10:'stairs_up.png', 11:'stairs_down.png'}.items()}
                ...
                try:
                    ...
                    for tex_x in range(scaled_texture.get_width()):
                        ...
                        if 0 <= current_screen_x < RENDER_WIDTH:
                            # --- POCZĄTEK POPRAWKI ---
                            # Obliczamy poprawny indeks dla z_buffer na podstawie pozycji piksela
                            ray_idx = int(current_screen_x * NUM_RAYS / RENDER_WIDTH)
                            
                            # Sprawdzamy bufor głębi używając POPRAWNEGO indeksu
