...
def game_loop_step(player, game_state, renderer, sprites, screen, render_surface, clock, font, ui_font, info_font, sprite_properties, sprite_textures, last_world_render, logger):
    dt = clock.tick(50)
...
async def main():
    ...
    while running:
        ...
        running = game_loop_step(player, game_state, renderer, sprites, screen, render_surface, clock, font, ui_font, info_font, SPRITE_PROPERTIES, SPRITE_TX, last_world_render, logger)
