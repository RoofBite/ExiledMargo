...
def game_loop_step(player, game_state, renderer, sprites, screen, render_surface, clock, font, ui_font, info_font, sprite_properties, sprite_textures):
    ...
    # POPRAWKA: Przekaż `game_state` do `player.update`
    ...
    # --- WARUNKOWA SEKCJA RYSOOWANIA GRAFIKI ---
    ...
    # --- SEKCJA RYSOOWANIA UI NA WIERZCHU (ZAWSZE AKTYWNA) ---
    if game_state.current_state == 'playing':
