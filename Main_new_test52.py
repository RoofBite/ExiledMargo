...
PLANE_PROPERTIES = {
    ...
    50: {"type": "floor", "texture": "wall17.png", "padding": 0.4},  # <- tutaj 20% rozszerzenia
...
class RainParticle:
    ...
    def draw(self, surface):
        ...
        # Rysujemy linię pod lekkim kątem dla lepszego efektu
...
class RainManager:
    def __init__(self, num_particles, screen_width, screen_height):
        self.particles = [RainParticle(screen_width, screen_height) for _ in range(num_particles)]

    def update(self):
        """Aktualizuje pozycję wszystkich kropli."""
...
SPRITE_PROPERTIES = {
    ...
    46: {"texture": "stairs_up.png", "scale_x": 1.2, "scale_y": 1.2, "blocking": True, "z": 0,
...
#         "type": "portal", "is_portal": True},
    ...
    3: {"texture": "rat2.png", "scale_x": 0.5, "scale_y": 0.5, "blocking": True, "z": 0,
        "type": "monster", "name": "Szczur",
        "level": 0.8, "archetype": "standard",
        "loot_table": [
        {'item': {"name": "Szczurzy ogon", "value": 2, "type": "loot"}, 'chance': 1.0},
        {'item': {"name": "Mięso", "value": 3, "type": "consumable", "heals": 10*2}, 'chance': 0.2}
    ]},
    4: {"texture": "rat3.png", "scale_x": 0.5, "scale_y": 0.5, "blocking": True, "z": 0,
        "type": "monster", "name": "Groźny Szczur",
        "level": 3.3, "archetype": "standard",
        "loot_table": [
        {'item': {"name": "Szczurzy ogon", "value": 2, "type": "loot"}, 'chance': 1.0},
        {'item': {"name": "Mięso", "value": 3, "type": "consumable", "heals": 10*2}, 'chance': 0.2},
    ...
    14: {"texture": "deer2.png", "scale_x": 1.2, "scale_y": 0.8, "blocking": True, "z": 0,
         "type": "monster", "name": "Jeleń",
         "level": 4, "archetype": "standard",
         "loot_table": [
        {'item': {"name": "Skóra Jelenia", "value": 12, "type": "loot"}, 'chance': 0.3},
        {'item': {"name": "Mięso", "value": 5, "type": "consumable", "heals": 10*2}, 'chance': 1}
    ]},
    15: {"texture": "bear3.png", "scale_x": 0.7, "scale_y": 0.7, "blocking": True, "z": 0,
         "type": "monster", "name": "Niedzwiedz",
         "level": 6.5, "archetype": "brute",
         "loot_table": [
            {'item':{"name": "Sadło", "value": 15, "type": "consumable", "heals": 20*2}, 'chance': 0.5},
    ...
    16: {"texture": "bear3.png", "scale_x": 0.7, "scale_y": 0.7, "blocking": True, "z": 0,
         "type": "monster", "name": "Niedzwiedz", "hp": 150*2, "attack": 5*2, "defense": 0, "xp_yield": 45*2,
         "loot_table": [
            {'item':{"name": "Sadło", "value": 15, "type": "consumable", "heals": 20*2}, 'chance': 0.5},
            {'item':{"name": "Skóra Niedzwiedzia", "value": 20, "type": "loot"},'chance':0.4}
        ]},
    22: {"texture": "rat_king2.png", "scale_x": 0.5, "scale_y": 0.5, "blocking": True, "z": 0, "aggressive": True,
        "type": "monster", "name": "Król Szczurów", "hp": 100*1.8, "attack": 12*2, "defense": 5*2, "xp_yield": 250*2,
        "loot_table": [
        {'item':{"name": "Korona Króla Szczurów", "value": 250, "type": "helmet", "defense": 3*2, "attack": 3*2}, 'chance': 1.0}
        ]},
    23: {"texture": "barell2.png", "scale_x": 0.5, "scale_y": 0.5, "blocking": True, "z": 0, "aggressive": False,
        "type": "monster", "name": "Beczka",
        "level": 2, "archetype": "blockade",
        "loot_table": [
            {'item' :{"name": "Mikstura leczenia", "value": 25, "type": "consumable", "heals": 50*2},'chance':0.25},
            {'item':{"name": "Sadło", "value": 15, "type": "consumable", "heals": 20*2}, 'chance': 0.5},
             {'item':{"name": "Drewniana tarcza", "value": 30, "type": "shield", "defense": 1.5*2}, 'chance': 0.25}
        ]},
    24: {"texture": "barell2.png", "scale_x": 0.5, "scale_y": 0.5, "blocking": True, "z": 0, "aggressive": False,
        "type": "monster", "name": "Wzmocniona Beczka",
        "level": 3, "archetype": "blockade",
        "loot_table": [
            {'item' :{"name": "Surowy ziemniak", "value": 25, "type": "consumable", "heals": -10},'chance':0.25},
            {'item':{"name": "Sadło", "value": 15, "type": "consumable", "heals": 20*2}, 'chance': 0.25},
    ...
    20: {"texture": "merchant.png", "scale_x": 1.0, "scale_y": 1.0, "blocking": True, "z": 0,
         ...
         "sells": [
             {"name": "Solidny miecz", "value": 90, "type": "weapon", "attack": 5*2, "level_req": 1},
             {"name": "Średni miecz", "value": 40, "type": "weapon", "attack": 3*2, "level_req": 1},
             # WYMAGANIE DLA ZBROI
             {"name": "Skórzana zbroja", "value": 130, "type": "armor", "defense": 3*2, "level_req": 4},
             {"name": "Żelazny hełm", "value": 80, "type": "helmet", "defense": 2*2, "level_req": 1},
             # Mikstury nie mają wymagań, ale możemy dodać dla spójności
             {"name": "Mikstura leczenia", "value": 25, "type": "consumable", "heals": 50*2, "level_req": 1}
         ]},
    21: {"texture": "healer.png", "scale_x": 1.0, "scale_y": 1.0, "blocking": True, "z": 0,
     ...
     "quest": Quest(
         ...
         reward={'xp': 120, 'money': 10, 'items': [
             ...
             {"name": "Uszkodzona tarcza", "value": 3, "type": "shield", "defense": 1*2, "level_req": 1}
         ]}
     )},
    # --- DEKORACJE ---
    ...
    101: {"texture": "sztylet.png", "scale_x": 0.3, "scale_y": 0.3, "blocking": False, "z": 0,
        "type": "pickup_item",
        "item_data": {
            "name": "Mały sztylet", "value": 15, "type": "weapon", "attack": 4, "defense": -4, "level_req": 1
        }},
    102: {"texture": "pink_shell.png", "scale_x": 0.3, "scale_y": 0.3, "blocking": False, "z": 0,
        "type": "pickup_item",
        "item_data": {
            "name": "Różowa muszelka", "value": 15, "type": "loot"
        }},
    103: {"texture": "stick.png", "scale_x": 0.45, "scale_y": 0.45, "blocking": False, "z": 0,
        "type": "pickup_item",
        "item_data": {
            "name": "Rózga", "value": 1, "type": "weapon", "attack": 2, "level_req": 1
        }},
}
...
def generate_monster_stats(level, archetype='standard'):
    ...
    archetypes = {
        ...
        'blockade':     {'hp_mod': 2.5, 'atk_mod': 0.1, 'def_mod': 1.5}, # <-- NOWY ARCHETYP DLA BECZEK/BLOKAD
    }
...
class GameState:
    ...
    def start_combat(self, monster, logger,player):
        ...
        logger.info(f"COMBAT_START; Monster: {monster.name}; MonsterHP: {monster.hp}/{monster.max_hp}; PlayerHP: {player.hp}/{player.max_hp}")
    ...
    def end_combat(self, player, logger, outcome): # <-- ZMIEŃ TĘ LINIĘ
        ...
        logger.info(f"COMBAT_END; Outcome: {outcome}; PlayerHP: {player.hp}/{player.max_hp}")
...
def game_loop_step(player, game_state, renderer, sprites, screen, render_surface, clock, font, ui_font, info_font, sprite_properties, sprite_textures, last_world_render, logger, rain_manager):
    dt = clock.tick(50)
    ...
    for e in pygame.event.get():
        ...
        if game_state.current_state == 'playing':
            if e.type == pygame.KEYDOWN:
                if e.key == pygame.K_w: player.grid_move(True, sprites, game_state,logger, player)
                if e.key == pygame.K_s: player.grid_move(False, sprites, game_state, logger, player)
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:
                if up_rect.collidepoint(mx, my): player.grid_move(True, sprites, game_state,logger, player)
                elif right_rect.collidepoint(mx, my): player.turn(False, game_state)
                elif down_rect.collidepoint(mx, my): player.grid_move(False, sprites, game_state, logger, player)
        ...
        # Stan: Walka
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and game_state.player_turn:
                ...
                if attack_rect.collidepoint(mx, my):
                    process_player_attack(player, game_state.active_monster, game_state, logger)
                    game_state.monster_attack_timer = pygame.time.get_ticks()
                
                
                elif power_rect.collidepoint(mx, my):
                    if player.moc > 0:
                        process_player_power_attack(player, game_state.active_monster, game_state,logger)
                        game_state.monster_attack_timer = pygame.time.get_ticks()
                    else:
        ...
        # Stan: Dialog
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:
                action_rects, leave_rect = draw_dialogue_ui(screen, player, game_state.active_npc, font, ui_font,logger)
                if leave_rect.collidepoint(mx, my): game_state.end_dialogue()
                    ...
                    if 'accept_quest' in action_rects and action_rects['accept_quest'].collidepoint(mx, my):
                        ...
                        player.active_quests[quest.name] = quest; game_state.set_info_message(f"{info}Przyjęto: {quest.name}")
        ...
        # Stany: Ekrany UI
                ...
                if e.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    for i, rect in enumerate(item_rects):
                        if rect.collidepoint(mx, my) and i < len(player.inventory): player.manage_item(player.inventory[i], game_state,logger); break
                        ...
                        if rect.collidepoint(mx, my):
                            ...
                            if player.money >= item_to_buy['value']:
                                if len(player.inventory) < player.inventory_limit:
                                    ...
                                    logger.info(f"ITEM_BUY; Item: {item_to_buy['name']}; Cost: {item_to_buy['value']}")
                ...
                if back_button_rect.collidepoint(mx, my): game_state.current_state = 'dialogue'; game_state.screen_dirty = True
                    ...
                    for i, rect in enumerate(sell_rects):
                        if rect.collidepoint(mx, my) and i < len(player.inventory):
                            ...
                            logger.info(f"ITEM_SELL; Item: {item_to_sell['name']}; Value: {item_to_sell['value']}")
                            break
    ...
    if game_state.current_state == 'combat' and not game_state.player_turn:
        if pygame.time.get_ticks() - game_state.monster_attack_timer > game_state.MONSTER_ATTACK_DELAY:
            process_monster_attack(player, game_state.active_monster, game_state,logger)
...
async def main():
    ...
    WALLS = {k: pygame.image.load(os.path.join(TEXTURE_PATH, f)).convert() for k, f in {1:'wall5.png', 2:'wall2.png', 97:'wall17.png',94:'wall17.png', 95:'wall12.png' ,96: 'door_closed_wall.png',10:'stairs_up.png', 11:'stairs_down.png', 47:'stairs_down.png'}.items()}
    ...
    # W funkcji async def main():
    # ZNAJDŹ I ZASTĄP starą pętlę ładującą tekstury podłóg tym kodem:
    ...
    renderer = Renderer(render_surface, player, MAPS, WALLS, sprites, HORIZONTAL_SURFACES, PLANE_PROPERTIES, SPRITE_PROPERTIES)
    ...
    while running:
        ...
        running = game_loop_step(player, game_state, renderer, sprites, screen, render_surface, clock, font, ui_font, info_font, SPRITE_PROPERTIES, SPRITE_TX, last_world_render, logger, rain_manager)
        await asyncio.sleep(0)
    logger.info("GAME_SESSION_END")
    pygame.quit()
...
class Player:
    ...
    def add_xp(self, amount, game_state,logger):
        ...
        logger.info(f"XP_GAIN; Amount: {amount}; TotalXP: {self.xp}/{self.xp_to_next_level}")
    ...
    def change_floor(self, destination_floor, game_state,logger):
        if destination_floor in self.maps:
            ...
            game_state.screen_dirty = True
            logger.info(f"FLOOR_CHANGE; NewFloor: {destination_floor}; Position: ({self.x/TILE:.1f}, {self.y/TILE:.1f})")
    ...
    def grid_move(self, forward, sprites, game_state, logger,player):
                ...
                if (si, sj) == (i, j):
                    ...
                    if spr.blocking:
                        ...
                        if spr.is_portal:
                            ...
                            if target_x is not None and target_y is not None and target_floor is not None:
                                # Przenosimy gracza na środek docelowego pola
                                self.x = (target_x + 0.5) * TILE
                                self.y = (target_y + 0.5) * TILE
                                self.floor = target_floor
                                logger.info(f"PORTAL_USE; FromFloor: {old_floor} -> ToFloor: {target_floor}; ToPosition: ({target_x}, {target_y})")
        ...
        if tile_content:
            for block in tile_content:
                  is_blocking_wall = (
                      ...
                      block.get('z', 0) == 0 and not ('target' in block or 'target_floor' in block)
                  )
                  if is_blocking_wall:
                      return
        ...
        if self.x != original_x or self.y != original_y:
            game_state.screen_dirty = True
            logger.info(f"MOVE; Position: ({self.x/TILE:.1f}, {self.y/TILE:.1f}); Floor: {self.floor}")
        ...
        if tile_content:
            ...
            if target_floor is not None:
                ...
                if target_x is not None and target_y is not None:
                    ...
                    logger.info(f"PORTAL_USE (Tile); FromFloor: {old_floor} -> ToFloor: {target_floor}; ToPosition: ({target_x}, {target_y})")
                
                # Upewnij się, że pozycja jest logowana po teleportacji
                logger.info(f"MOVE after portal; Position: ({self.x/TILE:.1f}, {self.y/TILE:.1f}); Floor: {self.floor}")
    ...
    def manage_item(self, item, game_state,logger):
        ...
        if item_type == "consumable":
            ...
            logger.info(f"ITEM_USE; Item: {item['name']}; Healed for: {item.get('heals', 0)}")
        ...
        if item_type in self.equipment:
            ...
            if self.level < level_req:
                game_state.set_info_message(f"Wymagany poziom {level_req}, aby założyć {item['name']}.")
...
# W klasie Renderer
    # Ta funkcja zastępuje starą funkcję o tej samej nazwie
    ...
    def draw_floor_and_ceiling_pygame(self):
        ...
        # Obliczamy wektory kierunku i płaszczyzny kamery (metoda precyzyjna)
        ...
        # Przygotowanie domyślnych tekstur/kolorów
        ...
        default_ceil_texture = None
        default_ceil_color = None
        ...
        custom_map = self.custom_surfaces.get(self.player.floor, {})
        padded_tiles = []
        player_map_x, player_map_y = int(self.player.x // TILE), int(self.player.y // TILE)
        view_dist = 20  # Zasięg sprawdzania w kafelkach
        for (mx, my), data in custom_map.items():
            if abs(mx - player_map_x) < view_dist and abs(my - player_map_y) < view_dist:
                floor_props = data.get('floor')
                if floor_props and float(floor_props.get('padding', 0.0)) > 0:
                    padded_tiles.append(((mx, my), floor_props))
        ...
        for y in range(horizon, RENDER_HEIGHT):
            ...
            for x in range(0, RENDER_WIDTH, PIXEL_SKIP):
                ...
                chosen_floor_props = None

                # --- OPTYMALIZACJA: Krok 2 - Zastosowanie wstępnej listy ---
                # 1. Zawsze sprawdzamy kafelek, na którym bezpośrednio jest piksel (szybkie).
                current_cell_data = custom_map.get((map_mx, map_my))
                if current_cell_data and current_cell_data.get('floor'):
                    chosen_floor_props = current_cell_data.get('floor')

                # 2. Sprawdzamy tylko przygotowaną wcześniej, krótką listę kafelków z paddingiem.
                candidates = []
                for (pt_mx, pt_my), props in padded_tiles:
                    pad = float(props.get('padding', 0.0))
                    # Ta sama logika co w Twoim kodzie: sprawdzenie, czy piksel jest w zasięgu.
                    if (pt_mx * TILE - pad * TILE <= world_x <= (pt_mx + 1) * TILE + pad * TILE and
                        pt_my * TILE - pad * TILE <= world_y <= (pt_my + 1) * TILE + pad * TILE):
                        center_x = pt_mx * TILE + TILE / 2
                        center_y = pt_my * TILE + TILE / 2
                        dist_sq = (world_x - center_x)**2 + (world_y - center_y)**2
                        candidates.append((dist_sq, props))
                
                # 3. Rozstrzygnięcie konfliktu, jeśli piksel jest w zasięgu kilku kafelków.
                if candidates:
                    candidates.sort(key=lambda t: t[0])
                    closest_padded_props = candidates[0][1]
                    
                    if not chosen_floor_props:
                        chosen_floor_props = closest_padded_props
                    else:
                        center_x = map_mx * TILE + TILE / 2
                        center_y = map_my * TILE + TILE / 2
                        current_dist_sq = (world_x - center_x)**2 + (world_y - center_y)**2
                        
                        if candidates[0][0] < current_dist_sq:
                            chosen_floor_props = closest_padded_props
                
                # 4. Ustawienie finalnej tekstury na podstawie wyniku.
                if chosen_floor_props:
                    tex_name = chosen_floor_props.get('texture')
                ...
                if texture_to_use:
                    ...
                    # Ta linia pozostaje NIETKNIĘTA, zgodnie z Twoją prośbą
        ...
        # RYSOWANIE SUFITU (pozostaje NIETKNIĘTE, zgodnie z Twoją prośbą)
        for y in range(horizon):
            ...
            for x in range(0, RENDER_WIDTH, PIXEL_SKIP):
                ...
                custom_data = self.custom_surfaces.get(self.player.floor, {}).get((map_mx, map_my))
                if custom_data and custom_data.get('ceiling'):
                    tex_name = custom_data['ceiling'].get('texture')
                    custom_tex = self.HORIZONTAL_SURFACES.get(tex_name)
                    if custom_tex: 
                        texture_to_use = custom_tex
                        color_to_use = None
    ...
    def draw_floor_and_ceiling_numpy(self):
        ...
        self.draw_horizontal_surface_numpy(horizon_y_abs - 1, -1, is_floor=False, step=-1)
    ...
    def draw_horizontal_surface_numpy(self, y_start, y_end, is_floor, step=1):
        ...
        # Ważna zmiana: używamy jednej nazwy słownika
        default_res = self.HORIZONTAL_SURFACES.get(default_res_name) if isinstance(default_res_name, str) else default_res_name

        for y in range(y_start, y_end, step):
            p = (y - horizon_y_abs) if is_floor else (horizon_y_abs - y)
            if p == 0: continue

            cam_z = (0.5 * self.player.height_in_level / TILE) if is_floor else (0.5 * (TILE - self.player.height_in_level) / TILE)
    ...
    def draw_walls(self):
            ...
            # <<< BRAKUJĄCA LINIA - ZOSTAŁA DODANA >>>
            horizon = RENDER_HEIGHT // 2 + int(self.player.pitch * RENDER_SCALE)
            ...
            for ray in range(NUM_RAYS):
                ...
                side_dx = ((x_map + (1 if cos_a > 0 else 0)) * TILE - pos_x) / (cos_a or 1e-6)
                side_dy = ((y_map + (1 if sin_a > 0 else 0)) * TILE - pos_y) / (sin_a or 1e-6)
                ...
                for _ in range(MAX_DEPTH):
                    ...
                    for block in sorted(wall_blocks, key=lambda b: b.get("z", 0)):
                        ...
                        if tex_id in self.SOLID_WALLS and y_top <= 0 and y_bottom >= RENDER_HEIGHT:
                            should_break_dda = True
                    if should_break_dda: break
...
def process_player_attack(player, monster, game_state,logger):
    ...
    logger.info(f"PLAYER_ATTACK; Target: {monster.name}; Damage: {dmg}; Crit: {is_crit}; MonsterHP: {monster.hp}/{monster.max_hp}")
    if monster.hp <= 0:
...
def process_monster_attack(player, monster, game_state,logger):
    ...
    player.hp -= dmg
    logger.info(f"MONSTER_ATTACK; Attacker: {monster.name}; Damage: {dmg}; Crit: {is_crit}; PlayerHP: {player.hp}/{player.max_hp}")
...
def handle_player_death(player, game_state, logger):
    ...
    # DODAJ TĘ LINIĘ
    logger.critical(f"PLAYER_DEATH; FinalLevel: {player.level}; FinalMoney: {player.money}")
